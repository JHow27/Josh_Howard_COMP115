...
name = "Josh"
hobby = "Hiking"
place_of_origin = "Vancouver"
coding_experience = "beginner"
weekly_hours_learn_coding = 8
my_github_comp115_repo = "https://github.com/JHow27/Josh_Howard_COMP115"

print(f"""Hi,

I am {name}. I like {hobby}.

I am from {place_of_origin}.
This is my first ever computer science class so my coding experience level is {coding_experience}.
I would love to learning coding {weekly_hours_learn_coding} hours per week.
This is my COMP115 repository at GitHub: {my_github_comp115_repo}.
