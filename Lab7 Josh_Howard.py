...
# Your unit tests
assert reverse_str("pal") == "lap"
assert reverse_str("sand") == "dnas"
...
# Your unit tests
remove_duplicates("paper") == "paer"
remove_duplicates("Poppy") == "Popy"
remove_duplicates("pear") == "pear"
...
# Your unit tests
project_completion_day('Monday', 11) == 'Friday'
project_completion_day('Monday', 14) == 'Monday'
project_completion_day('Saturday', 3) == 'Tuesday'
project_completion_day('Saturday', 8) == 'Sunday'
