...
dividend = 10
divisor = 3
quotient = dividend // divisor  # Modify the operator to get the quotient 3
remainder = dividend % divisor   # Modify the operator to get the remainder 1
division_result = dividend / divisor
print("10 divided by 3 is", division_result)
print("10/3 =", quotient, "with a remainder of", remainder)
...
mark_average = (marks[0] + marks[1] + marks[2] + marks[3]) / 4  # Modify the expression to calculate the correct average
print("the average mark on this test was", mark_average)
...
print("the area of a circle with radius 2 is radius squared multiplied by pi, which is", area)
...
print(f"Your trip starts on day {day_today}, and lasts {days_trip} days. You are back on day {day_after_trip}.")
